...
class CfgVehicles {
    ...
    class CavMod_B_B_PlatoonSergeant_F;
    class CavMod_B_B_PlatoonLeader_F;
    class CavMod_B_B_PlatoonMedic_F;
    ...
    class CavMod_B_B_SquadLeader_F;
    ...
    class CavMod_B_B_Ifv_Commander_F;

    class CavMod_B_B_Ifv_Commander_B_1_F : CavMod_B_B_Ifv_Commander_F {
        _generalMacro = "CavMod_B_B_Ifv_Commander_B_1_F";
        scope = 1;
        scopeCurator = 0;
    ...
    class CavMod_B_B_Ifv_Commander_B_2_F : CavMod_B_B_Ifv_Commander_F {
        _generalMacro = "CavMod_B_B_Ifv_Commander_B_2_F";
        scope = 1;
        scopeCurator = 0;
    ...
    class CavMod_B_B_Ifv_Commander_B_3_F : CavMod_B_B_Ifv_Commander_F {
        _generalMacro = "CavMod_B_B_Ifv_Commander_B_3_F";
        scope = 1;
        scopeCurator = 0;
    ...
    class CavMod_B_B_Ifv_Commander_B_4_F : CavMod_B_B_Ifv_Commander_F {
        _generalMacro = "CavMod_B_B_Ifv_Commander_B_4_F";
        scope = 1;
        scopeCurator = 0;
    ...
    // Charlie
    class CavMod_B_C_PlatoonSergeant_F;
    class CavMod_B_C_PlatoonLeader_F;
    class CavMod_B_C_PlatoonMedic_F;

    class CavMod_B_C_PlatoonSergeant_1_5_F : CavMod_B_C_PlatoonSergeant_F {
        _generalMacro = "CavMod_B_C_PlatoonSergeant_1_5_F";
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonSergeant_1_5);
        author = ECSTRING(Main,CavModTeam);
    ...
    class CavMod_B_C_PlatoonLeader_1_6_F : CavMod_B_C_PlatoonLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonLeader_1_6);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 1;
    };
    class CavMod_B_C_PlatoonMedic_1_7_F : CavMod_B_C_PlatoonMedic_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonMedic_1_7);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 1;
    };
    ...
    class CavMod_B_C_PlatoonSergeant_2_5_F : CavMod_B_C_PlatoonSergeant_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonSergeant_2_5);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    class CavMod_B_C_PlatoonLeader_2_6_F : CavMod_B_C_PlatoonLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonLeader_2_6);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    class CavMod_B_C_PlatoonMedic_2_7_F : CavMod_B_C_PlatoonMedic_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_PlatoonMedic_2_7);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    ...
    class CavMod_B_C_SquadLeader_1_2_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_1_2);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 1;
    };
    class CavMod_B_C_SquadLeader_1_3_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_1_3);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 1;
    };
    class CavMod_B_C_SquadLeader_1_4_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_1_4);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 1;
    };
    ...
    class CavMod_B_C_SquadLeader_2_1_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_2_1);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    class CavMod_B_C_SquadLeader_2_2_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_2_2);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    class CavMod_B_C_SquadLeader_2_3_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_2_3);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };
    class CavMod_B_C_SquadLeader_2_4_F : CavMod_B_C_SquadLeader_F {
        ...
        scope = 1;
        scopeCurator = 0;
        displayName = CSTRING(C_SquadLeader_2_4);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Charlie_Rifleman_F.jpg);
        cavPlatoon = 2;
    };

    class CavMod_B_C_Weap_SquadLeader_F;
