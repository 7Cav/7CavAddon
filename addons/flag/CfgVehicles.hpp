...
class CfgVehicles {
    ...
    class Cav_Flag_00_Flag_F : FlagCarrier_Asym {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_00_ca.paa));
        };
    };
    ...
    class Cav_Flag_01_Flag_F : FlagCarrier_Asym {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_01_ca.paa));
        };
    };
    ...
    class Cav_Flag_02_Flag_F : FlagCarrier {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_02_ca.paa));
        };
    };
    class Cav_Flag_alpha_1_Flag_F : FlagCarrier {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_alpha1_ca.paa));
        };
    };
    class Cav_Flag_bravo_2_flag_F : FlagCarrier_Asym {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_bravo2_ca.paa));
        };
    };
    ...
    class Cav_Flag_charlie_1_flag_F : FlagCarrier_Asym {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_charlie1_ca.paa));
        };
    };
    ...
    class Cav_Flag_charlie_2_flag_F : FlagCarrier_Asym {
        ...
        class EventHandlers {
            init = QUOTE(_this select 0 setFlagTexture QPATHTOF(data\flag_charlie2_ca.paa));
        };
    };
