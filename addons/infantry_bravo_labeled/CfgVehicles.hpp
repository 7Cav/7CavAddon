class CfgVehicles {
    ...
    class Cav_B_B_PlatoonSergeant_2_5_F: Cav_B_B_PlatoonSergeant_F {
        ...
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_PlatoonSergeant_2_5_F);
    ...
    class Cav_B_B_PlatoonLeader_2_6_F: Cav_B_B_PlatoonLeader_F {
        ...
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_PlatoonLeader_2_6_F);
        author = ECSTRING(Main,ModTeam);
    ...
    class Cav_B_B_PlatoonMedic_2_7_F: Cav_B_B_PlatoonMedic_F {
        ...
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_PlatoonMedic_2_7_F);
        author = ECSTRING(Main,ModTeam);
    ...
    class Cav_B_B_SquadLeader_2_1_F: Cav_B_B_SquadLeader_F {
        ...
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_SquadLeader_2_1_F);
        author = ECSTRING(Main,ModTeam);
    ...
    class Cav_B_B_SquadLeader_2_2_F: Cav_B_B_SquadLeader_2_1_F {
        _generalMacro = "Cav_B_B_SquadLeader_2_2_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_SquadLeader_2_2_F);
        author = ECSTRING(Main,ModTeam);

        cav_squad = 2;
    };
    class Cav_B_B_SquadLeader_2_3_F: Cav_B_B_SquadLeader_2_1_F {
        _generalMacro = "Cav_B_B_SquadLeader_2_3_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_SquadLeader_2_3_F);
        author = ECSTRING(Main,ModTeam);

        cav_squad = 3;
    };
    class Cav_B_B_SquadLeader_2_4_F: Cav_B_B_SquadLeader_2_1_F {
        _generalMacro = "Cav_B_B_SquadLeader_2_4_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(Cav_B_B_SquadLeader_2_4_F);
        author = ECSTRING(Main,ModTeam);
