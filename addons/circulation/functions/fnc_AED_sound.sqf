...
if !(_caller getVariable ["cav_soundplayed", false]) then {
    _caller setVariable ["cav_soundplayed", true, true];
    _args spawn {
        ...
        sleep 1.5;
        if !(_caller getVariable ["cav_soundplayed", false]) exitWith {};
        ...
        _caller setVariable ["cav_soundplayed", false, true];
    };
};
