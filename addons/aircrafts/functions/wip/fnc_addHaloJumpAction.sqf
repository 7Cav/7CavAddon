...
if (!isNil {GETVAR(_vehicle,QGVAR(HaloJumpAction))}) exitWith {};
...
private _actionID = [
    ...
    {},
    {
        ...
        [_caller, _target, _chuteBackpackClass, _allowStaggared] call FUNC(handleHaloJump)
    },
    {},
...
SETVAR(_vehicle,QEGVAR(HaloJumpAction),_actionID);
