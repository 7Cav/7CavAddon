class CfgVehicles {
    ...
    class Cav_B_Bravo_Scout_PlatoonSergeant_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_PlatoonSergeant_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_PlatoonSergeant);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
    ...
    class Cav_B_Bravo_Scout_PlatoonLeader_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_PlatoonLeader_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_PlatoonLeader);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
    ...
    class Cav_B_Bravo_Scout_VicCommander_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_VicCommander_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_VicCommander);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
    ...
    class Cav_B_Bravo_Scout_Driver_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_Driver_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_Driver);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
    ...
    class Cav_B_Bravo_Scout_Gunner_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_Gunner_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_Gunner);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
    ...
    class Cav_B_Bravo_Scout_Infantry_F : Cav_B_Bravo_Scout_base_F {
        _generalMacro = "Cav_B_Bravo_Scout_Infantry_F";
        scope = 2;
        scopeCurator = 0;
        displayName = CSTRING(B_Bravo_Scout_Infantry);
        author = ECSTRING(Main,CavModTeam);
        //editorPreview = QPATHTOF(EditorPreviews\I_Cav_Bravo_Rifleman_F.jpg);
